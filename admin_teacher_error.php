...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-content container">
      ...
      <!-- ABOUT ME -->
        <div class="student">
          <h3 class="studenttab">| <small><a href="admin.php" class="at">Admin's Info</a></small> | <small><a href="admin_teacher.php" class="st">Teacher's Info</a></small> | <small><a href="admin_student.php" class="at">Student's Info</a></small> |</h3>
...
<b style='color:red;'>MAAF, USERNAME TELAH DIGUNAKAN ATAU TELAH ADA. SILAHKAN DAFTAR DENGAN USERNAME LAIN YANG BELUM TERDAFTAR</b><br><br>
...
<?php
  ...
  if (isset ($_POST['kirim'])){
    ...
    if (empty($usernamee) or empty ($password)){
      ...
      $querykirim="insert guru values ('$usernamee','$password','$nama','$alamat','$jenis_kelamin','$nomor_hp','$emaill')";
      $hasilkirim = mysqli_query($conn, $querykirim) or die(header("Location: admin_teacher_error.php"));
...
<form action="admin_teacher.php" method="post">
...
<b style='color:green;'>DATA BERHASIL DIUBAH</b><br><br>
            ...
            while($data7 = mysqli_fetch_array($hasil7)){
              echo"
                <tr>
                  ...
                  <a href='admin_teacher_edit.php?&edit&id=$data7[0]'>Edit</a>&nbsp;&nbsp;&nbsp;

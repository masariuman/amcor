      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav">
            <li class="active nav1 animated rollIn"><a href="indexadmin.php">HOME <span class="sr-only">(current)</span></a></li>
            <li class="nav2 animated rollIn"><a href="newsadmin.php">NEWS</a></li>
            <li class="nav4 animated rollIn"><a href="admin.php">ADMIN</a></li>
          </ul>

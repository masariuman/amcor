...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav">
            <li class="active nav1 animated rollIn"><a href="indexsiswa.php">HOME <span class="sr-only">(current)</span></a></li>
            <li class="nav2 animated rollIn"><a href="newssiswa.php">NEWS</a></li>
            <li class="nav4 animated rollIn"><a href="students.php">STUDENT</a></li>
          </ul>

          <!-- Media Sosial -->
          <ul class="navkanan">
            <li class="twitter animated bounceInDown"><a href="logout.php"><!-- <i class="fa fa-twitter"></i> --><!--LOGIN BUTTON--><input type="submit" name="submit" value="Logout" class="button1"><!--END LOGIN BUTTON--></a></li>
    ...
    <!-- HEADER -->
    <header class="container-fluid animated bounceInLeft">
      <div class="row"> 

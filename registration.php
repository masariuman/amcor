  ...
  <?php 
      ...
      if(isset($_COOKIE['amcor'])){
        ...
        if ($user === $data['username']) {
          ...
          header("Location: registrationiswa.php");
        }
        if ($user === $data1['username']) {
          header("location: registrationguru.php");
        }
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="nav44 animated bounceInDown active"><a href="registration.php">REGISTRATION</a></li>
      ...
      <!-- registration  -->
        <div class="registration">
          <form action="mailto:masariuman@gmail.com" method="post">
            ...
            <br>
            <input type="text" name="username" value="USERNAME" id="hilang">
            <br>
            <input type="email" name="email" value="EMAIL ADDRESS" id="hilang">
            <br>
            <input type="password" name="password" value="PASSWORD" id="hilang">
            <br>
            <input type="password" name="repassword" value="PASSWORD" id="hilang">
            <br>

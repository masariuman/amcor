...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-content container">
      ...
      <!-- ABOUT ME -->
        <div class="student">
          <h3 class="studenttab">| <small><a href="teacher.php" class="st">Student's Info</a></small> | <small><a href="teacher_score.php" class="at">Student's Score</a></small>  | <small><a href="teacher_admin.php" class="at">Admin's Info</a></small> |</h3>
          
          <?php 

              require("teacher_student.php");

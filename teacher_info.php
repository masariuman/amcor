...
require("koneksi.php");
  ...
  $hasil6 = mysqli_query($conn, $query6) or die("Error");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-content container">
      ...
      <!-- ABOUT ME -->
        <div class="student">
          <h3 class="studenttab">| <small><a href="students.php" class="at">BIODATA</a></small> | <small><a href="score.php" class="at">SCORE</a></small> | <small><a href="teacher_info.php" class="st">TEACHER INFO</a></small> |</h3>
          
          <h4>TEACHER'S INFO</h4><hr>
            ...
            while($data6 = mysqli_fetch_array($hasil6)){
              echo"
                <tr>
                  ...
                  <td align='center' style='padding: 6px 10px;' valign='center'>$data6[2]</td>
                  <td align='center' style='padding: 6px 10px;' valign='center'>$data6[3]</td>
                  <td align='center' style='padding: 6px 10px;' valign='center'>$data6[4]</td>
                  <td align='center' style='padding: 6px 10px;' valign='center'>$data6[5]</td>
                  <td align='center' style='padding: 6px 10px;' valign='center'>$data6[6]</td>";
                echo"</tr>";
              $x++;
            } ?>

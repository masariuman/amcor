...
<?php
  ...
  if(isset($_GET['edit'])){
    $id  = $_GET['id'];
    $query11="select * from daftarnilai_ic1 where username = '$id'";
    $query12="select * from daftarnilai_ic2 where username = '$id'";
    $query13="select * from daftarnilai_ic3 where username = '$id'";
    $hasil21 = mysqli_query($conn, $query11) or die("Error11");
    $hasil22 = mysqli_query($conn, $query12) or die("Error12");
    $hasil23 = mysqli_query($conn, $query13) or die("Error13");
    $sqle = mysqli_fetch_array($hasil21);
    $sqlee = mysqli_fetch_array($hasil22);
    $sqleee = mysqli_fetch_array($hasil23);
    $usernamed = $sqle[0];  
    $pre_test     = $sqle[1];
    $post_test    = $sqle[2];
    $pre_test1    = $sqlee[1];
...
<form action="proses_ubah_data_score.php" method="post">
<table border="0">
<tr>
...
<td>
  ...
  <table border='0' style='border-collapse:collapse;' cellpadding='5' cellspacing='0'><input type='hidden' name='username' value='<?php echo"$usernamed"; ?>'>
    ...
    <tr>
      <td style="padding: 6px 10px;" valign='center'>NOMOR INDUK SISWA : </td><td><input type="text" disabled name="usernamee" style='width:150px;' value='<?php echo"$usernamed"; ?>'></td>
    </tr>
    <tr>
      <td style="padding: 6px 10px;" valign='center'>PRE-TEST : </td><td><input type="text" name="pre_test" style='width:150px;' value='<?php echo"$pre_test"; ?>'></td>
    </tr>
    <tr>
      <td style="padding: 6px 10px;" valign='center'>POST-TEST : </td><td><input type="text" name="post_test" style='width:150px;' value='<?php echo"$post_test"; ?>'></td>
    </tr>
  </table>
...
<td>
  ...
  <table border='0' style='border-collapse:collapse;' cellpadding='5' cellspacing='0'>
    ...
    <tr>
      <td style="padding: 6px 10px;" valign='center'>PRE-TEST : </td><td><input type="text" name="pre_test1" style='width:150px;' value='<?php echo"$pre_test1"; ?>'></td>
    </tr>
    <tr>
      <td style="padding: 6px 10px;" valign='center'>POST-TEST : </td><td><input type="text" name="post_test1" style='width:150px;' value='<?php echo"$post_test1"; ?>'></td>
    </tr>
  </table>
...
<td>
  ...
  <table border='0' style='border-collapse:collapse;' cellpadding='5' cellspacing='0'>
    ...
    <tr>
      <td style="padding: 6px 10px;" valign='center'>PRE-TEST : </td><td><input type="text" name="pre_test2" style='width:150px;' value='<?php echo"$pre_test2"; ?>'></td>
    </tr>
    <tr>
      <td style="padding: 6px 10px;" valign='center'>POST-TEST : </td><td><input type="text" name="post_test2" style='width:150px;' value='<?php echo"$post_test2"; ?>'></td>
    </tr>
  </table>
...
<tr>
  <td colspan="3" align="center">
    <input type="submit" value='UBAH' name='ubah' style="padding: 6px 10px;" valign='center'>
    </td>
    </tr>
